...
class CualificatedSurveyWidget extends StatefulWidget {
  ...
  static String routeName = 'CualificatedSurvey';
  static String routePath = '/cualificatedSurvey';
...
class _CualificatedSurveyWidgetState extends State<CualificatedSurveyWidget> {
  ...
  void initState() {
    ...
    _model.birthYearMask = MaskTextInputFormatter(mask: '####');
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            context
                                .goNamed(CompleteRegistrationWidget.routeName);
