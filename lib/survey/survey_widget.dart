  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: StreamBuilder<SurveysRecord>(
            ...
            builder: (context, snapshot) {
              ...
              final columnSurveysRecord = snapshot.data!;
              return Column(
                ...
                children: [
                  ...
                  if (columnSurveysRecord.hasDescription())
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(10.0, 5.0, 0.0, 0.0),
                      child: Text(
                        columnSurveysRecord.description,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Readex Pro',
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          columnSurveysRecord.approximateTime1.toString(),
                          style:
                        ...
                        Text(
                          columnSurveysRecord.approximateTime2.toString(),
                          style: FlutterFlowTheme.of(context).bodyMedium,
                        ),
                      ],
                    ),
