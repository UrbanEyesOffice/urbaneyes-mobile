...
class ImagePickerModel extends FlutterFlowModel<ImagePickerWidget> {
  ...
  bool isDataUploading_imagePickerCameraComponent = false;
  FFUploadedFile uploadedLocalFile_imagePickerCameraComponent =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  bool isDataUploading_imagePickerGalleryComponent = false;
  List<FFUploadedFile> uploadedLocalFiles_imagePickerGalleryComponent = [];
  ...
  bool isDataUploading_imagePickerCameraComponent2 = false;
  FFUploadedFile uploadedLocalFile_imagePickerCameraComponent2 =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  bool isDataUploading_imagePickerGalleryCpmponent2 = false;
  List<FFUploadedFile> uploadedLocalFiles_imagePickerGalleryCpmponent2 = [];
