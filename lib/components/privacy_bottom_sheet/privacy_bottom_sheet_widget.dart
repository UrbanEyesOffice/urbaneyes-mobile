...
class _PrivacyBottomSheetWidgetState extends State<PrivacyBottomSheetWidget> {
  late PrivacyBottomSheetModel _model;
          ...
          children: [
            FFButtonWidget(
              ...
              text: FFLocalizations.of(context).getText(
                'fyn6s0hn' /* Политика конфиденциальности */,
              ),
            ...
            Padding(
              ...
              child: FFButtonWidget(
                ...
                text: FFLocalizations.of(context).getText(
                  '658o929i' /* Пользовательское соглашение */,
                ),
                options: FFButtonOptions(
                  width: double.infinity,
                  height: 60.0,
