...
import 'rewards_copy_copy_model.dart';
export 'rewards_copy_copy_model.dart';

class RewardsCopyCopyWidget extends StatefulWidget {
  const RewardsCopyCopyWidget({Key? key}) : super(key: key);

  @override
  _RewardsCopyCopyWidgetState createState() => _RewardsCopyCopyWidgetState();
}

class _RewardsCopyCopyWidgetState extends State<RewardsCopyCopyWidget> {
  late RewardsCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RewardsCopyCopyModel());
                                ...
                                Align(
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) =>
                                      ...
                                      center: Text(
                                        rewardsItem.pointsNeeded.toString(),
                                      ...
                                      Padding(
                                        ...
                                        child: SelectionArea(
                                          ...
                                          FFLocalizations.of(context)
                                              .getVariableText(
                                            ruText:
                                                rewardsItem.rewardDescription,
                                            enText:
                                                rewardsItem.rewardDescriptionEn,
                                            kyText:
                                                rewardsItem.rewardDescriptionKg,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
