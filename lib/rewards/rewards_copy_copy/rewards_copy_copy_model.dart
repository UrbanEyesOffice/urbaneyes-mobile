...
import 'rewards_copy_copy_widget.dart' show RewardsCopyCopyWidget;
...
class RewardsCopyCopyModel extends FlutterFlowModel<RewardsCopyCopyWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in RewardsCopyCopy widget.
  List<RewardsRecord>? loadedRewards;
  // Stores action output result for [Custom Action - filterRewardsByUserId] action in RewardsCopyCopy widget.
