...
class CollectedRewardsWidget extends StatefulWidget {
  const CollectedRewardsWidget({super.key});

  static String routeName = 'CollectedRewards';
  static String routePath = '/collectedRewards';

  @override
  State<CollectedRewardsWidget> createState() => _CollectedRewardsWidgetState();
}
