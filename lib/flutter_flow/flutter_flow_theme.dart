...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color mainGreen = const Color(0xFF53B153);
  late Color secondaryGreen = const Color(0xFFCEEFCD);
  late Color featuredBlue = const Color(0xFF2E74EA);
}
