...
class QuestionCopyModel extends FlutterFlowModel<QuestionCopyWidget> {
  ...
  bool isDataUploading_uploadImagesNextCopy = false;
  List<FFUploadedFile> uploadedLocalFiles_uploadImagesNextCopy = [];
  List<String> uploadedFileUrls_uploadImagesNextCopy = [];

  bool isDataUploading_uploadImagesCompleteCopy = false;
  List<FFUploadedFile> uploadedLocalFiles_uploadImagesCompleteCopy = [];
  List<String> uploadedFileUrls_uploadImagesCompleteCopy = [];
