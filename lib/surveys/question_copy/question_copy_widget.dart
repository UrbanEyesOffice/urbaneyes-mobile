...
class QuestionCopyWidget extends StatefulWidget {
  ...
  static String routeName = 'questionCopy';
  static String routePath = '/questionCopy';
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (isWeb) {
        ...
        logFirebaseEvent('questionCopy_request_permissions');
      ...
      _model.currentQuestion =
          widget!.questions?.elementAtOrNull(_model.currentQuestionNumber);
      safeSetState(() {});
      if (isWeb) {
        logFirebaseEvent('questionCopy_update_page_state');
      ...
      logFirebaseEvent('questionCopy_bottom_sheet');
          ...
          child: Padding(
            ...
            child: ListView(
              ...
              children: [
                    ...
                    return Column(
                      ...
                      children: List.generate(options.length, (optionsIndex) {
                        ...
                        return FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'QUESTION_COPY_Button_dzj3iskk_ON_TAP');
                            if (_model.currentQuestion!.multiselect) {
                              ...
                              logFirebaseEvent('Button_update_page_state');
                              _model.selectedOption = optionsItem;
                              safeSetState(() {});
                            }
                          },
                          text: FFLocalizations.of(context).getVariableText(
                            ruText: optionsItem.titleRu,
                            enText: optionsItem.titleEn,
                            kyText: optionsItem.titleKg,
                          ),
                          options: FFButtonOptions(
                            ...
                            color: () {
                              if (valueOrDefault<bool>(
                                optionsItem.id == _model.selectedOption?.id,
                                false,
                              )) {
                                return Color(0xFF53B153);
                              } else if (_model.selectedOptions
                                  .contains(optionsItem)) {
                                return FlutterFlowTheme.of(context).mainGreen;
                              } else {
                ...
                if (!functions.isLastQuestion(
                  ...
                  FFButtonWidget(
                    onPressed: ((_model.selectedOption == null) &&
                        ...
                        ? null
                        : () async {
                            logFirebaseEvent('QUESTION_COPY_PAGE__BTN_ON_TAP');
                            logFirebaseEvent('Button_upload_file_to_firebase');
                            {
                              safeSetState(() => _model
                                  .isDataUploading_uploadImagesNextCopy = true);
                              ...
                              try {
                                ...
                                ScaffoldMessenger.of(context)
                                    .hideCurrentSnackBar();
                                _model.isDataUploading_uploadImagesNextCopy =
                                    false;
                              }
                              if (selectedUploadedFiles.length ==
                                ...
                                safeSetState(() {
                                  _model.uploadedLocalFiles_uploadImagesNextCopy =
                                      selectedUploadedFiles;
                                  _model.uploadedFileUrls_uploadImagesNextCopy =
                                      downloadUrls;
                                });
                                showUploadMessage(
                                  context,
                            ...
                            _model.currentQuestion = _model.questions
                                .elementAtOrNull(_model.currentQuestionNumber);
                  ...
                  FFButtonWidget(
                    onPressed: ((_model.selectedOption == null) &&
                        ...
                        : () async {
                            ...
                            {
                              safeSetState(() => _model
                                      .isDataUploading_uploadImagesCompleteCopy =
                                  true);
                              var selectedUploadedFiles = <FFUploadedFile>[];
                              var selectedFiles = <SelectedFile>[];
                              var downloadUrls = <String>[];
                              try {
                                ...
                                _model.isDataUploading_uploadImagesCompleteCopy =
                                    false;
                              }
                              if (selectedUploadedFiles.length ==
                                      selectedFiles.length &&
                                  downloadUrls.length == selectedFiles.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFiles_uploadImagesCompleteCopy =
                                      selectedUploadedFiles;
                                  _model.uploadedFileUrls_uploadImagesCompleteCopy =
                                      downloadUrls;
                                });
                              } else {
                                safeSetState(() {});
                            ...
                            _model.addToAnswers(AnswerStruct(
                              ...
                              answers: _model.selectedOptions,
                              images: _model
                                  .uploadedFileUrls_uploadImagesCompleteCopy,
                            ));
                            safeSetState(() {});
                ...
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('QUESTION_COPY_PAGE___BTN_ON_TAP');
