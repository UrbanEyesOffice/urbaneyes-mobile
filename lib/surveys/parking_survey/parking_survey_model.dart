...
class ParkingSurveyModel extends FlutterFlowModel<ParkingSurveyWidget> {
  ...
  bool isDataUploading_uploadWrongParkingPhotoCamera1 = false;
  FFUploadedFile uploadedLocalFile_uploadWrongParkingPhotoCamera1 =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  bool isDataUploading_uploadWrongParkingPhotoGallery1 = false;
  List<FFUploadedFile> uploadedLocalFiles_uploadWrongParkingPhotoGallery1 = [];
  ...
  bool isDataUploading_uploadWrongParkingPhotoCamera2 = false;
  FFUploadedFile uploadedLocalFile_uploadWrongParkingPhotoCamera2 =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  bool isDataUploading_uploadWrongParkingPhotoGallery2 = false;
  List<FFUploadedFile> uploadedLocalFiles_uploadWrongParkingPhotoGallery2 = [];
  ...
  bool isDataUploading_finalUploadImages = false;
  List<FFUploadedFile> uploadedLocalFiles_finalUploadImages = [];
  List<String> uploadedFileUrls_finalUploadImages = [];
