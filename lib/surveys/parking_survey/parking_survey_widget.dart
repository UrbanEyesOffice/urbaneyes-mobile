...
class ParkingSurveyWidget extends StatefulWidget {
  ...
  static String routeName = 'ParkingSurvey';
  static String routePath = '/parkingSurvey';
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    safeSetState(() => _model
                                            .isDataUploading_uploadWrongParkingPhotoCamera1 =
                                        true);
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadWrongParkingPhotoCamera1 =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadWrongParkingPhotoCamera1 =
                                  ...
                                  if (_model.uploadedLocalFile_uploadWrongParkingPhotoCamera1 !=
                                          null &&
                                      (_model.uploadedLocalFile_uploadWrongParkingPhotoCamera1
                                              .bytes?.isNotEmpty ??
                                          false)) {
                                    ...
                                    _model.addToLocalImages(_model
                                        .uploadedLocalFile_uploadWrongParkingPhotoCamera1);
                                    safeSetState(() {});
                                  }
                                },
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (selectedMedia != null &&
                                      selectedMedia.every((m) =>
                                          validateFileFormat(
                                              m.storagePath, context))) {
                                    safeSetState(() => _model
                                            .isDataUploading_uploadWrongParkingPhotoGallery1 =
                                        true);
                                    var selectedUploadedFiles =
                                        <FFUploadedFile>[];
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadWrongParkingPhotoGallery1 =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFiles_uploadWrongParkingPhotoGallery1 =
                                  ...
                                  if (_model
                                      .uploadedLocalFiles_uploadWrongParkingPhotoGallery1
                                      .isNotEmpty) {
                              ...
                              Expanded(
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (selectedMedia != null &&
                                        selectedMedia.every((m) =>
                                            validateFileFormat(
                                                m.storagePath, context))) {
                                      safeSetState(() => _model
                                              .isDataUploading_uploadWrongParkingPhotoCamera2 =
                                          true);
                                      var selectedUploadedFiles =
                                          <FFUploadedFile>[];
                                      ...
                                      try {
                                        ...
                                        _model.isDataUploading_uploadWrongParkingPhotoCamera2 =
                                            false;
                                      }
                                      if (selectedUploadedFiles.length ==
                                          selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFile_uploadWrongParkingPhotoCamera2 =
                                              selectedUploadedFiles.first;
                                        });
                                      } else {
                                        safeSetState(() {});
                                    ...
                                    if (_model.uploadedLocalFile_uploadWrongParkingPhotoCamera2 !=
                                            null &&
                                        (_model.uploadedLocalFile_uploadWrongParkingPhotoCamera2
                                                .bytes?.isNotEmpty ??
                                            false)) {
                                      logFirebaseEvent(
                                          'Button_update_page_state');
                                      _model.addToLocalImages(_model
                                          .uploadedLocalFile_uploadWrongParkingPhotoCamera2);
                                      safeSetState(() {});
                                    }
                                  },
                                  text: FFLocalizations.of(context).getText(
                              ...
                              Expanded(
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (selectedMedia != null &&
                                        selectedMedia.every((m) =>
                                            validateFileFormat(
                                                m.storagePath, context))) {
                                      safeSetState(() => _model
                                              .isDataUploading_uploadWrongParkingPhotoGallery2 =
                                          true);
                                      var selectedUploadedFiles =
                                          <FFUploadedFile>[];
                                      ...
                                      try {
                                        ...
                                        _model.isDataUploading_uploadWrongParkingPhotoGallery2 =
                                            false;
                                      }
                                      if (selectedUploadedFiles.length ==
                                          selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFiles_uploadWrongParkingPhotoGallery2 =
                                              selectedUploadedFiles;
                                        });
                                      } else {
                                        safeSetState(() {});
                                    ...
                                    if (_model
                                        .uploadedLocalFiles_uploadWrongParkingPhotoGallery2
                                        .isNotEmpty) {
                                      logFirebaseEvent('Button_custom_action');
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.localImages.length > 0) {
                                    ...
                                    {
                                      safeSetState(() => _model
                                              .isDataUploading_finalUploadImages =
                                          true);
                                      var selectedUploadedFiles =
                                          <FFUploadedFile>[];
                                      ...
                                      try {
                                        ...
                                        _model.isDataUploading_finalUploadImages =
                                            false;
                                      }
                                      if (selectedUploadedFiles.length ==
                                              selectedMedia.length &&
                                          downloadUrls.length ==
                                              selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFiles_finalUploadImages =
                                              selectedUploadedFiles;
                                          _model.uploadedFileUrls_finalUploadImages =
                                              downloadUrls;
                                        });
                                      } else {
                                        safeSetState(() {});
                                    ...
                                    await ParkingRecord.collection.doc().set({
                                      ...
                                      ...mapToFirestore(
                                        {
                                          'images': _model
                                              .uploadedFileUrls_finalUploadImages,
                                        },
                                      ),
                                    });
