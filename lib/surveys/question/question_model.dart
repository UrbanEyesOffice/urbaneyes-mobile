...
class QuestionModel extends FlutterFlowModel<QuestionWidget> {
  ...
  bool isDataUploading_uploadImagesNext = false;
  List<FFUploadedFile> uploadedLocalFiles_uploadImagesNext = [];
  List<String> uploadedFileUrls_uploadImagesNext = [];

  bool isDataUploading_uploadImagesComplete = false;
  List<FFUploadedFile> uploadedLocalFiles_uploadImagesComplete = [];
  List<String> uploadedFileUrls_uploadImagesComplete = [];
